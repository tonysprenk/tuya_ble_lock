...
class TuyaBLELockConfigFlowTest(unittest.TestCase):
    ...
    def assert_credentials_updated(self, flow, entry):
        ...
        self.assertEqual(entry.data[module.CONF_TUYA_EMAIL], "new@example.com")
        self.assertEqual(entry.data[module.CONF_TUYA_PASSWORD], "new-password")
        self.assertEqual(entry.data[module.CONF_TUYA_COUNTRY], "31")
        self.assertEqual(entry.data[module.CONF_TUYA_REGION], "eu")
